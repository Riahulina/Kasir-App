...
const CATEGORIES = CATEGORY_DEFS.filter((c) => c.label !== "Semua").map(
  (c) => c.label,
);
...
const generateId = () =>
  "prod_" + Date.now().toString(36) + Math.random().toString(36).slice(2);
...
export default function ProductScreen({ onBack }: Props) {
  ...
  const handleSave = () => {
    ...
    if (
      ...
      Alert.alert("Perhatian", "Harga tidak valid");
      return;
    }
    if (
      !formStock.trim() ||
      isNaN(Number(formStock)) ||
      Number(formStock) < 0
    ) {
      Alert.alert("Perhatian", "Stok tidak valid");
      return;
    }
      ...
      <View style={styles.statsRow}>
        ...
        <View style={styles.statCard}>
          <View
            style={[
              styles.statIconBox,
              { backgroundColor: lowStock > 0 ? "#fef2f2" : "#f0fdf4" },
            ]}
          >
            <Ionicons
              name="warning"
              size={18}
              color={lowStock > 0 ? "#ef4444" : "#22c55e"}
            />
          </View>
          <Text
            style={[styles.statNumber, lowStock > 0 && { color: "#ef4444" }]}
          >
            {lowStock}
          </Text>
        ...
        {filtered.length === 0 ? (
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptySubtitle}>
              Coba ubah kata kunci atau tambah produk baru
            </Text>
            <TouchableOpacity
                ...
                <View style={styles.modalTitleRow}>
                  ...
                  >
                    <Ionicons
                      ...
                      size={20}
                      color={editingProduct ? "#f97316" : "#22c55e"}
                    />
                  </View>
              ...
              >
                ...
                <TouchableOpacity
                  style={[
                    ...
                    showCategoryPicker && styles.categorySelectorActive,
                  ]}
                ...
                {showCategoryPicker && (
                  <View style={styles.categoryOptions}>
                    {CATEGORY_DEFS.filter((c) => c.label !== "Semua").map(
                      (cat) => (
                        <TouchableOpacity
                          key={cat.label}
                          style={[
      ...
      >
        <TextInput
          style={[
            ...
            multiline && { textAlignVertical: "top", height: 80 },
          ]}
        ...
        <View style={styles.productTop}>
          ...
          <View
            style={[
              ...
              { backgroundColor: def.lightBg, borderColor: def.color + "40" },
            ]}
          >
            <Ionicons
              name={def.icon as any}
              ...
              style={{ marginRight: 3 }}
            />
            <Text style={[styles.categoryBadgeText, { color: def.color }]}>
              {product.category}
            </Text>
          </View>
        </View>
        ...
        <View style={styles.productBottom}>
          <View>
            ...
            <View style={styles.stockRow}>
              ...
              />
              <Text
                style={[styles.stockText, isLowStock && { color: "#ef4444" }]}
              >
                Stok: {product.stock}
                {isLowStock ? " ⚠️" : ""}
              </Text>
...
const styles = StyleSheet.create({
  ...
  headerSub: { fontSize: 13, color: "#16a34a", marginTop: 2 },
  addBtnHeader: {
    width: 40,
    height: 40,
    borderRadius: 12,
  ...
  searchFocused: { borderColor: "#22c55e" },
  ...
  fieldInputFocused: { borderColor: "#22c55e", backgroundColor: "#fff" },
  fieldTextInput: {
  ...
  categorySelectorActive: { borderColor: "#22c55e", backgroundColor: "#fff" },
  catSelectorIconBox: {
    width: 30,
    height: 30,
    borderRadius: 8,
